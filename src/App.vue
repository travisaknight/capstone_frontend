<template>
  <div id="app">
    ...
    <div class="layout">
                ...
                <ul>
                  ...
                  <li>
                    <a class="nav-btn external" href="#">
                      <div class="btn btn-circle btn-brand">Get started</div>
                    </a>
                  </li>
                </ul>
              </div>
      ...
      <div class="wrapper">
        <!-- Page Header-->
        <section class="module-slides" id="home">
          <ul class="slides-container">
            <li class="bg-dark bg-dark-30">
              <img src="assets/images/module-12.jpg" alt="" />
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h1 class="h1 wow fadeInDown">Do You Even..</h1>
                    <h1 class="h1 m-b-20 wow fadeInDown" data-wow-delay="0.5s">LIFT?</h1>
            ...
            <li class="bg-light-30">
              <img src="assets/images/module-9.jpg" alt="" />
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
          ...
          <div class="container-fluid">
            ...
            <div class="row row-portfolio" date-portfolio-type="standard" data-columns="3">
              ...
              <div class="portfolio-item branding photo undefined">
                ...
                <a class="portfolio-link" href="portfolio-single-1.html"></a>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="icon-box icon-box-left">
                  ...
                  <div class="icon-box-content">
                    <p>
                      Especially do at he possession insensible sympathize boisterous it. Songs he on an widen me event
                      truth.
                    </p>
                  </div>
                </div>
        ...
        <!-- Alt Services-->
        <section class="module module-divider-bottom" id="services">
          <div class="container">
            <div class="row">
              <div class="col-md-8 m-auto">
                <div class="module-title text-center">
